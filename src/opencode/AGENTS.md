...
| Y Combinator-style startup consulting / office hours — idea validation, talk to users, MVP, growth, default alive, fundraising, founder issues, YC application/interview prep | `ycombinator` |
