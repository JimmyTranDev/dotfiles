...
Load skills: **meta-structure**, **code-quality**, **strategy-pragmatic-programmer**, and **code-conventions**.
...
2. Analyze the architecture across these dimensions (only include dimensions that are relevant):
...
5. Present findings:
   - Group by dimension from step 2
...
6. Write findings to a spec file using the `architecture-` prefix per the `specify-*` conventions in AGENTS.md.
