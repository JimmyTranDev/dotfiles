...
- Logical correctness (contradictions, invalid state machines, missing branches) — load the **code-logic-checker** skill
- Structural code quality (naming conventions, function design, duplication) — load the **code-quality** skill
