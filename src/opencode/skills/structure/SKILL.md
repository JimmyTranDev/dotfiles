...
- How to write TypeScript types and patterns — see **total-typescript** skill
- Naming conventions and code style rules — see **conventions** skill
- UI component design patterns and theming — see **designer-ui-ux** skill
- Code deduplication and extraction — see **deduplicator** skill
- Merging over-separated files — see **consolidator** skill
