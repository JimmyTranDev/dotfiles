...
- Creating a new branch as a worktree (`wcreated`), optionally named from a Jira ticket.
...
4. **Decide the branch name:**
   - Input matches `^[A-Z]+-[0-9]+$`: optionally fetch the summary —
