...
For extracting repeated patterns into shared utilities, load the **code-deduplicator** skill.
For merging over-separated code, load the **code-consolidator** skill.
```
