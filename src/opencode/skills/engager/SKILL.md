...
- Game mechanics implementation (points, XP, levels, achievements, leaderboards) — load the **gamification** skill
- UI component architecture and visual design — load the **designer-ui-ux** skill
- Animation and micro-interaction implementation — load the **ux-ui-animator** skill
