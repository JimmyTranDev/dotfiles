...
maps('n', {
  ...
  { '<Leader>ugH', link_actions.open_current_github_repo, '󰓢 Repo pull requests' },
...
maps('n', {
  ...
  { '<Leader>uwo', worktree_actions.checkout_worktree, '󰓡 Checkout worktree (remote branch → wcheckout)' },
