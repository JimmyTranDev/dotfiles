...
map('n', '<Leader>up', git_actions.open_or_create_pull_request, { desc = '󰦥 GitHub: open/create PR' })
map('n', '<Leader>uP', git_actions.copy_pr_link, { desc = '󰦥 GitHub: copy PR link' })
map('n', '<Leader>ur', link_actions.open_current_github_repo, { desc = '󰦥 GitHub: repo page' })
map('n', '<Leader>ua', link_actions.open_current_github_prs, { desc = '󰦥 GitHub: all PRs' })
map('n', '<Leader>uh', github_actions.open_current_repo_in_browser, { desc = '󰦥 GitHub: repo homepage' })
map('n', '<Leader>uj', link_actions.open_jira_ticket, { desc = '󰦥 Jira: open ticket from branch' })
map('n', '<Leader>uJ', jira_actions.browse_my_tasks, { desc = '󰦥 Jira: browse my tasks' })
map('n', '<Leader>uU', jira_actions.browse_recently_updated_tasks, { desc = '󰦥 Jira: recently updated tasks' })
map('n', '<Leader>um', github_actions.select_own_open_prs, { desc = '󰦥 GitHub: my open PRs' })
map('n', '<Leader>ul', link_actions.open_useful_link, { desc = '󰦥 Links: useful links' })
map('n', '<Leader>uL', link_actions.open_private_useful_link, { desc = '󰦥 Links: private links' })
map('n', '<Leader>ug', github_actions.list_org_repos_and_open, { desc = '󰦥 GitHub: org repos' })
map('n', '<Leader>ut', link_actions.open_technical_link_current_repo, { desc = '󰦥 Links: technical (repo)' })
map('n', '<Leader>uT', link_actions.open_technical_link, { desc = '󰦥 Links: technical (select)' })
...
map('n', '<Leader>uN', github_actions.show_notifications, { desc = '󰦥 GitHub: all notifications' })
map('n', '<Leader>un', github_actions.show_notifications_by_default_team, { desc = '󰦥 GitHub: team notifications' })
map('n', '<Leader>ub', github_actions.show_notifications_by_team, { desc = '󰦥 GitHub: team notifications (select)' })
...
-- map('n', '<Leader>uw', github_actions.select_open_prs_by_people, { desc = 'Open PRs by people' })
