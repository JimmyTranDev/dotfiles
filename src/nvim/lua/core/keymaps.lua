...
map('n', '<Leader>ut', link_actions.open_technical_link_current_repo, { desc = '󰦥 Technical link (current repo)' })
map('n', '<Leader>uT', link_actions.open_technical_link, { desc = '󰦥 Technical link (select project)' })
