...
map('n', '<Leader>ugm', github_actions.select_own_open_prs, { desc = '󰦥 GitHub: my open PRs' })
map('n', '<Leader>ugo', github_actions.list_org_repos_and_open, { desc = '󰦥 GitHub: org repos' })
map('n', '<Leader>ugN', github_actions.show_notifications, { desc = '󰦥 GitHub: all notifications' })
map('n', '<Leader>ugn', github_actions.show_notifications_by_default_team, { desc = '󰦥 GitHub: team notifications' })
map('n', '<Leader>ugb', github_actions.show_notifications_by_team, { desc = '󰦥 GitHub: team notifications (select)' })
map('n', '<Leader>ugw', github_actions.select_open_prs_by_default_team, { desc = '󰦥 GitHub: team PRs' })
map('n', '<Leader>ugW', github_actions.select_open_prs_by_people, { desc = '󰦥 GitHub: team PRs (select)' })
