...
main() {
	...
	# 2. Open in the directory of the currently-focused pane (no prompt). Fall
	#    back to the last project, then the fzf picker, when the pane cwd can't
	#    be resolved (e.g. outside a tracked dir).
	local target_dir
