...
main() {
	...
	# Open nvim in a new stacked pane rooted in the chosen project — the
	# project-picking counterpart to the "Alt '" stacked nvim pane. The pane
	# closes itself when nvim exits (--close-on-exit), mirroring the
